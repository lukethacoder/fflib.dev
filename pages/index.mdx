...
<div className="home-content">
  <div className="content-container">
    <h1 className="headline">Apex Enterprise <br className='sm:block hidden'/>Framework</h1>
    <p className="subtitle">Streamline and standardise your Salesforce development process with fflib</p>
  ...
  <div className="features-container">
    <div className="content-container">
      <Features>
        <Feature index={0} href="/docs/selector-layer">
          <h3>Selector Layer</h3>
          <p className='mr-6'>A place for your queries and field references to call home.</p>
        </Feature>
        <Feature index={1} href="/docs/domain-layer">
          <h3>Domain Layer</h3>
          <p className='mr-6'>Object level data manipulation and trigger handler methods.</p>
        </Feature>
        <Feature index={2} href="/docs/service-layer">
          <h3>Service Layer</h3>
          <p className='mr-6'>Business logic. Creator and manager of **UnitOfWork**.</p>
        </Feature>
        <Feature index={2} href="/docs/triggers">
          <h3>Triggers</h3>
          <p className='mr-6'>fflib flavoured Trigger Handler concepts.</p>
        </Feature>
        <Feature index={2} href="/docs/unit-of-work">
          <h3>Unit Of Work</h3>
          <p className='mr-6'>Handle CRUD operations in an easily testable and mockable way.</p>
        </Feature>
      </Features>
    </div>
  </div>
